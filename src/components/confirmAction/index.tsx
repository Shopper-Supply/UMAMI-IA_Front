...
const ConfirmAction = ({ message, setStatus }: IConfirmAction) => {
  ...
  return (
    <div className="absolute z-50 w-[100%] h-[100%] flex justify-center backdrop-blur-sm bg-black bg-opacity-20">
      <div className="translate-y-[20rem] flex justify-center absolute">
